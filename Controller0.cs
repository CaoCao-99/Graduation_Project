    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        private void Start()
        {
         ...
         Debug.LogError( "Starter Assets package is missing dependencies. Please use Tools/Starter Assets/Reinstall Dependencies to fix it");
            ...
            GameObject.Find("Camera").transform.Find("ThirdCam").gameObject.SetActive(true);
            GameObject.Find("Camera").transform.Find("OneCam").gameObject.SetActive(false);
            state1 = true;
            state2 = false;
            ...
            if (pv.IsMine)
            {
                GameObject.Find("ThirdCam").GetComponent<CinemachineVirtualCamera>().Follow = transform.Find("PlayerCameraRoot");
                GameObject.Find("Camera").transform.Find("OneCam").GetComponent<CinemachineVirtualCamera>().Follow = transform.Find("PlayerCameraRoot");
            }
        }
